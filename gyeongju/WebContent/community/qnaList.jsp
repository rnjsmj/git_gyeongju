...
<style>
	...
	table { border: 1px #a39485 solid; font-size: 18px; box-shadow: 0 2px 5px rgba(0,0,0,.25); width: 1200px; margin: 40px auto; border-collapse: collapse; border-radius: 5px; overflow: hidden; }
...
<div id="contents" class="clr-fix">
	...
	<section id="page1">
		...
		<div class="buttons">
			<c:if test="${not empty sid }">
			<a id="insbtn" role="button" href="${path0 }/QnaInsert.do">문의 등록</a>
			</c:if>
		</div>
	</section>
			<!-- <div id="board-search">
